 ...
 */
export type RenderMathInElementOptions = KatexOptions &
    RenderMathInElementSpecificOptions;

/**
 * Replace TeX expressions with rendered HTML
 * @param text Text to replace
 * @param options Render options
 * @returns Text with rendered HTML
 */
declare function renderMathInText(
    text: string,
